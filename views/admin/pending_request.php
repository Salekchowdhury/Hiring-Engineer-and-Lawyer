            ...
            <div class="content">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-plain">
                            <div class="card-header">
                                <h4 class="card-title">Engineer Request</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="scroll-content" style="height: 300px;">
                                    <table class="table">
                                        ...
                                        <tbody>
                                     <?php
                                     $data=$dataManipulation->viewAllEngineerPendingProfile();
                                     $s=1;
                                     if($data){
                                         foreach ($data as $list){
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="text-center">
                                                     <a class="btn bg-success fancy" data-type="iframe" title="Confirm" href="../dataprocess/admin_data_process.php?confirm_engineer_id=<?php echo $list->id?>"><i class="far fa-check-circle"></i></a>
                                                     <a class="btn bg-primary fancy" data-type="iframe" title="View Profile" href="engineer_profile.php?engineer_id=<?php echo $list->id?>"><i class="fa fa-eye"></i></a>
                    ...
                    <div class="col-md-6">
                        <div class="card card-plain">
                            <div class="card-header">
                                <h4 class="card-title">Lawyer Request</h4>
                            </div>
                            <?php

                            if(isset($_SESSION['ConfirmData'])){
                                echo $_SESSION['ConfirmData'];
                                unset($_SESSION['ConfirmData']);
                            }
                            ...
                            <div class="card-body">
                                <div class="scroll-content" style="height: 300px;">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php
                                        $data=$dataManipulation->viewAllLawyerPendingProfile();
                                        $s=1;
                                        if($data){
                                            foreach ($data as $list){
                                                ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn bg-success fancy" data-type="iframe" title="Confirm" href="../dataprocess/admin_data_process.php?confirm_lawyer_id=<?php echo $list->id?>"><i class="far fa-check-circle"></i></a>
                                                        <a class="btn bg-primary fancy" data-type="iframe" title="View Profile" href="lawyer_profile.php?Lawyer_id=<?php echo $list->id?>"><i class="fa fa-eye"></i></a>
