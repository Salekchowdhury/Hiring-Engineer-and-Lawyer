                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="callout callout-info" >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="submit" name="notic_post" class="form-control btn btn-outline-secondary notice-submit " value="Add Notice">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                    ...
                                    <h5><i class="fas fa-info"></i> Notice View:</h5>
                                    <?php
                                        ...
                                        foreach ($list as $lists){
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-4 btn-group" style="padding-left: 190px">
                                                        <a  href="edit_notice.php?edit_notice=<?php echo $lists->id?>" class="btn btn-success btn-round">Edit</a>
                                                        <a  href="../dataprocess/admin_data_process.php?delete_notice=<?php echo $lists->id?>" class="btn btn-danger btn-round">Delete</a>
