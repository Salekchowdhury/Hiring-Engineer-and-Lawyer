                        ...
                        <div class="col-12 mt-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                    <?php
                                    $data=$dataManipulation->showAllDeleteAccount();
                                    $s=1;
                                    if($data){
                                        foreach ($data as $list){
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                        ...
                                                        <a class="btn bg-danger btn-outline-success fancy" data-type="iframe" href="../dataprocess/admin_data_process.php?changeDeleteToyesApproved=<?php echo $list->id?>"><i class="far fa-times-circle"></i></a>
