                        ...
                        <div class="col-sm-4" style="margin: 20px">
                            <div style="height: 500px; width: 300px; border: 1px solid; border-color: #a71d2a; border-radius: 25px; box-shadow: 3px 3px 8px #0F0F0F , -3px -3px 8px black;">
                                ...
                                if($approved=='yes'){
                                    ...
                                    ?>
                                    <a href="../dataprocess/admin_data_process.php?confirm_lawyer_id=<?php echo $egineerData->id?>"  class="btn bg-success fancy" data-type="iframe" style="margin-left: 15px" type="submit" class="btn btn-primary"  name="change_profile" value="Confirm"><i class="fas fa-check-circle"></i> Confirm</a>
                                    <?php
                                }
                                ?>
