            ...
            <div   class="content wow bounceInUp" data-wow-duration= "2s" style="padding-top: 30px">
                <div class="row">
                    ...
                    <div class="col-12" style="padding-top: 55px;">
                        <?php
                        if($_GET['engineer_id']){
                            $engineerData=$dataManipulation->showEngineerProfileBYid($_GET['engineer_id']);
                        ...
                        <div style="border-radius: 15px; border: 2px solid;  background-color: white;   margin-top: -20px;  border-color: #28a745; box-shadow: 5px 10px 10px 2px black" class="tab-pane ">
                            <form class="form-horizontal" action="../dataprocess/email.php" method="post">
                                ...
                                <input class="user_id" name="engineerEmail" type="hidden" value="<?php echo $engineerEmail?>" >
                                <input class="user_id" name="name" type="hidden" value="<?php echo $engineerData->fullname?>" >
                                ...
                                <div style="padding: 10px" class="form-group row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input  disabled=""  class="form-control" name="email" value="<?php echo $userData->email?>">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <br>
                                        <div class="col-sm-10">
                                            <input  class="form-control" name="subject" value="" placeholder="Your Subject">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                       <br>
                                        <div class="col-sm-10">
                                            <textarea  class="form-control " placeholder="Type Message-------" rows="20" cols="10" name="message" value=""></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-2 col-sm-10">
                                        <button type="submit" class="btn btn-primary btn-outline-success" name="Mesaage_send_to_engineer" ><i class="fas fa-paper-plane"></i> Message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
