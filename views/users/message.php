...
if (isset($_SESSION['email'])){
                    ...
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="card-header">
                                ...
                                <input type="hidden" class="user_id" value="<?php echo $userData->id?>">
                                <input type="hidden" class="user_name" value="<?php echo $userData->name?>">
                            ...
                            <div class="card-body">
                                <div class="scroll-content" style="height: 300px;">
                                    <table class="table">
                                        ...
                                        $data=$reg->alluserengineer_lawyerEmail();
                                        $s=1;
                                        if($data){
    ...
    <script>
                    ...
                    success:function (result) {
                        ...
                        for (var f = 0; f<ary.length; f++) {
                            for (var i = 0; i < datas.length; i++) {
                                if ((datas[i].messageRead == "unseen") && (datas[i].eng_law_id == ary[f]) ) {
                                    console.log(datas)
                                    $('.attrTable tr').each(function (a, b) {
                                        var name = $('.attrName', b).text();
                                        /*var value = $('.attrValue', b).attr('data-id');*/
                                        if($(".attrValue",b).attr('data-id') == datas[i].eng_law_id){
                                            j=j+1;
        ...
        $(".show-chat-box-click").click(function () {
            ...
            var sellers_name = $(this).parent().parent().find('td').eq('2').text().trim();
        ...
        $(".chatSendBtn").click(function () {
            ...
            var sellers_name = $(".sellers_name").val().trim();
                                ...
                                for(var i =0; i<data.length;i++){
                                    if(data[i].message_from !=null){
                                        htmlstring +="<div class=\"direct-chat-msg\">\n" +
                                            ...
                                            "                            <span class=\"direct-chat-name float-left\">" + data[i].users_name + "</span>\n" +
                                    ...
                                    if(data[i].message_to !=null){
                                        htmlstring += "<div class=\"direct-chat-msg right\">\n" +
                                            "                        <div class=\"direct-chat-infos clearfix\">\n" +
                                            "                            <span class=\"direct-chat-name float-right\">"+ data[i].eng_law_name + "</span>\n" +
